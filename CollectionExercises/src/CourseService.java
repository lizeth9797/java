...
public class CourseService
{
    ...
    public void enrollStudent(String studentId, String courseId){
    	...
    	//para mayor facilidad crearemos el objeto student y el objeto course:
    ...
    public void displayCourseInformation(String courseId){
    	...
    	Course course=courses.get(courseId);
    	System.out.println(course.toString()); //no es necesario mandar a llamar el metodo toString ya que al usar un println internamente va a imprimir a string equal to "null"; otherwise, the value of obj.toString() is returned. Y es NECESARIO tener el "toString()" en la clase Courses y Student si los queremos imprimir
    }
